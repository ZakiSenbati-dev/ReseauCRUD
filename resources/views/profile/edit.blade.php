...
<x-master title="Modifier le profil">
            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card border-0 shadow-lg rounded-4">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('profiles.update', $profile->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                               id="floatingName" placeholder="Nom complet"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                               id="floatingEmail" placeholder="exemple@domaine.com"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea name="bio" class="form-control @error('bio') is-invalid @enderror"
                                                  ...
                                                  style="height: 120px;">{{ old('bio', $profile->bio) }}</textarea>
